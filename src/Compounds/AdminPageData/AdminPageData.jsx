...
const AdminPageData = (props) => {
  ...
  function deleteData(id) {
    ...
    fetch(`https://volunteer-network-server-jv30.onrender.com/delete/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((result) => {});
  ...
  return (
    <div className="d-flex">
      ...
      <span onClick={() => deleteData(`${_id}`)} className="mb-2 between">
        {" "}
        <img className="dlt-img" src={deleteImg} alt="" />
      </span>{" "}
      <br />
    </div>
  );
