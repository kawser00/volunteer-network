  ...
  return (
    <div className="container-fluid mt-4 px-3 d-flex">
      <div className="col-md-2 bg-white">
        <Link to="/home">
          <img className="mb-5" height="50" src={logo} alt="" />
        </Link>
        <div
        ...
        >
          <img style={{ width: "20px" }} src={userIcon} alt="" /> Volunteer
          register list
        </div>
        <div
          ...
          className="mt-4"
        >
          <img style={{ width: "20px" }} src={plusIcon} alt="" /> Add Event
        </div>
      </div>
